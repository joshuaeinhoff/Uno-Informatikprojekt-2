...
Method s = null;
try {
s = unotempel.Tempel.class.getMethod("main", String[].class); 
} catch(Exception findMainException) {
System.err.println("Error: Main method not found in class unotempel.Tempel, please define the main method as:");
