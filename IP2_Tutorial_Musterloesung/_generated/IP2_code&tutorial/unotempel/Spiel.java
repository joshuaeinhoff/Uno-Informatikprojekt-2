...
public class Spiel {
    ...
    public static void main(String[] args){
		...
		// Rätsel lösen
        heldHatGewonnen = wasserTempel.heldHatQuizGeloest(held, spielNiveau, gui);
        gui.spielbrettDarstellen(held);
        if(!heldHatGewonnen)
       		return;
        ...
        // Monster Kämpfen
        heldHatGewonnen = wasserTempel.heldHatMonsterBesiegt(held, gui);
		gui.spielbrettDarstellen(held);        
        if(!heldHatGewonnen)
       		return;
        heldHatGewonnen = !heldHatGewonnen;
        ...
        // Rätsel lösen
        heldHatGewonnen = luftTempel.heldHatQuizGeloest(held, spielNiveau, gui);
        gui.spielbrettDarstellen(held);
        if(!heldHatGewonnen)
            return;
        heldHatGewonnen = !heldHatGewonnen;
        ...
        // Monster Kämpfen
        heldHatGewonnen = luftTempel.heldHatMonsterBesiegt(held, gui);
        gui.spielbrettDarstellen(held);
		if(!heldHatGewonnen)
       		return;
        heldHatGewonnen = !heldHatGewonnen;
        ...
        // Rätsel lösen
        heldHatGewonnen = erdeTempel.heldHatQuizGeloest(held, spielNiveau, gui);
        gui.spielbrettDarstellen(held);
        if(!heldHatGewonnen)
            return;
        heldHatGewonnen = !heldHatGewonnen;
        ...
        // Monster Kämpfen
        heldHatGewonnen = erdeTempel.heldHatMonsterBesiegt(held, gui);
        gui.spielbrettDarstellen(held);
		if(!heldHatGewonnen)
       		return;
        heldHatGewonnen = !heldHatGewonnen;
		...
		// Rätsel lösen
        heldHatGewonnen = feuerTempel.heldHatQuizGeloest(held, spielNiveau, gui);
        gui.spielbrettDarstellen(held);
        if(!heldHatGewonnen)
       		return;
        heldHatGewonnen = !heldHatGewonnen;
        ...
        // Monster Kämpfen
        heldHatGewonnen = feuerTempel.heldHatMonsterBesiegt(held, gui);
        gui.spielbrettDarstellen(held);
        if(!heldHatGewonnen)
       		return;
        heldHatGewonnen = !heldHatGewonnen;
