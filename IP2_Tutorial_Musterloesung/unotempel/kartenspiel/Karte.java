...
public abstract class Karte {
    ...
    /** 1.1 Daten als Instanz-Variablen definieren Δe_8sjw50 Δ */
    String farbe;
    int nummer;


    /** 1.2 Superkonstruktor erstellen  Δe_de5i1n Δ 
    ...
    /** 1.3 Prüfe, ob eine Karte spielbar ist Δe_lggjxn Δ 
	...
	/**
    * Abstrakte Prozedur erzeugt die visuelle Darstellung einer Karte und versteckt sie direkt danach
